function writeSCAPSscript_withgeneration1(pathin,fileout)
...
fprintf(fip,'load generationfile pr_cell.gen\n');
fprintf(fip,'action generationfile pr_cell.gen\n');
fprintf(fip,'action light\n');
...
% fprintf(fip,'get energybands.efn x\n');
fprintf(fip,'get energybands.efp y\n');
